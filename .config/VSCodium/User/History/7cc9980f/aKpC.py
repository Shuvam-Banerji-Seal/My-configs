...
def main():
    ...
    results_dir = "/home/shuvam/Information_Retrieval/reults_bm25/results_2"
    summary_output_path = "/home/shuvam/Information_Retrieval/reults_bm25/output/summary_day2.txt"
    ...
    with open(summary_output_path, 'w') as summary_file:
        for k1, b, mrr in summary_data:
            summary_file.write(f"k1: {k1}, b: {b}, MRR: {mrr}\n")
