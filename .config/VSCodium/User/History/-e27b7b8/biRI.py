...
def process_document(obj):
    ...
    length_diff = corrected_text_length - original_text_length
    updated_sections = []
    for section in sections:
        start = section['start']
        end = section['end']
        section_text = corrected_text[start:end + length_diff]
    ...
    return {'doc_id': doc_id, 'text': corrected_text, 'sections': updated_sections}
